...
- **Projeto: Calculadora de preços simplificada**
- **Número da Sprint: 01**
- **Período: 10/09 - 24/09**
- **Integrantes: Felipe Aso, Gustavo Viana, Patric Morales, Rene Rocha**
- **Scrum Master da Sprint: Gustavo Viana**
...
|---|---|---|---|
| US01 Registrar itens | Gustavo, Rene |  |  |
| US02 Selecionar itens para criar um prato| Felipe, Rene  |  |  |
